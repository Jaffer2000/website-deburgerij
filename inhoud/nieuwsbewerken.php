...
<div class="col-sm-12" >
        <h1 class="headertext" style="color:black;">Nieuws bewerken</h1>
    </div>
            ...
            <div class="card-body">
                <form action="" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                        ...
                        <input type="text" id="activiteitnaam" value="' . $row['titel'] . '" class="form-control activiteitnaamtoevoegen" name="activiteitnaam" required>
                    </div>
